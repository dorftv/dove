...
from dove.api.output_models import SuccessDTO, OutputDeleteDTO
from dove.api.auth import require_role, require_read

from dove.api.helper import get_routers
from dove.api.helper import get_model_fields
...
for router_module, module_name in get_routers('dove.api.outputs'):
...
async def get_output_models():
    return get_model_fields('dove.api.outputs',{'OutputDTO'})

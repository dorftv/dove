...
from dove.api.helper import get_encoder_types
from dove.api.auth import require_role, require_read, is_auth_enabled, get_current_user
...
def get_available_elements():
    from dove.pipelines.element_registry import get_available_audio_filters, get_available_video_filters
    return {
...
def _get_viewer_count():
    from dove.api.websockets import manager
...
async def _check_admin(request: Request) -> bool:
    ...
    from dove.api.auth import is_auth_enabled, get_current_user, _get_config

...
from dove.pipelines.mixers.mixer import Mixer
from dove.pipelines.audio_filters import build_audio_filter_str
from dove.pipelines.video_filters import build_video_filter_str
from dove.api.mixers_dtos import programMixerDTO, mixerCutProgramDTO
import gi
...
class programMixer(Mixer):
    ...
    async def update(self, data):
        ...
        from dove.api.input_models import AudioFilterDTO, VideoFilterDTO
